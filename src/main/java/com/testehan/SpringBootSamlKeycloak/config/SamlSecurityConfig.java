package com.testehan.SpringBootSamlKeycloak.config;

import com.testehan.SpringBootSamlKeycloak.authentication.SAMLUserDetailsServiceImpl;
...
public class SamlSecurityConfig {
    ...
    public KeyManager keyManager() {
        ...
        Resource storeFile = loader.getResource(samlKeystorePath);
    ...
    /*
        Note: There are two ways to access ExtendedMetadataDelegate: By Url or XML File in both cases you need to access
        by IDP_REALM was created on keycloak.
    ...
    public ExtendedMetadataDelegate keycloakExtendedMetadataProvider()
        ...
        HTTPMetadataProvider httpMetadataProvider = new HTTPMetadataProvider(timer, httpClient(), idpSSOKeycloakMetadataURL);
